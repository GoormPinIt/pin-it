...
const Sec1 = () => {
    ...
    return(
        ...
        <div className=" flex-col justify-items-center overflow-x-hidden mt-20 h-screen bg-white relative">
          ...
          <div className="w-full text-center py-6 bg-pinit-yellow font-bold mt-auto ">Here's how it works</div>                              
        </div>
  ...
  return (
    <div className='bg-bg-pink flex justify-center items-center h-screen'>
      <div className='flex-1 m-auto relative'>
        ...
        <span className='text-2xl text-rose-950 font-semibold'> easy chicken dinner</span>
        </div>
      </div>
      <div className='flex-1 items-center text-center'>
        <h1 className='text-5xl text-t2-pink font-bold my-4'>Search for an idea</h1>
          <p  className='text-center text-2xl w-1/2 text-t2-pink mx-auto my-4'>
          What do you want to try next? Think of
          something you're into - such as 'easy
  ...
  <div className='bg-bg-green flex justify-center items-center h-screen'>
    ...
    <div className="w-1/2 h-full relative flex flex-wrap justify-start items-start mt-48">  
      <div className="flex w-full">
        <CardImg className="w-96 h-96 backdrop-opacity-90 object-fill text-5xl" text="Fern future home vibes" link="https://i.pinimg.com/736x/07/4f/72/074f729bd6f33ad88733b5de8353b9ed.jpg" />
        <div className="flex flex-col ml-10">
          <CardImg className="w-52 h-52 object-fill text-xl text-left mb-10" text="My Scandinavian bedroom" link="https://i.pinimg.com/736x/3a/e2/6e/3ae26e5b6f93e9d35b2e72e12ec7eced.jpg" />
          <CardImg className="w-44 h-44 object-fill text-xl text-left" text="The decking of my dreams" link="https://i.pinimg.com/736x/d1/84/f5/d184f5e6fcb73f471f4e59fef62670d9.jpg" />
        </div>
      </div>
  
      <div className="grid grid-cols-2 w-full -mt-24">
        <CardImg className="w-60 h-60 ml-24 object-fill text-3xl text-left" text="Serve my drinks in style" link="https://i.pinimg.com/736x/f9/1e/3e/f91e3e620cedc23ccd85180d90be4b24.jpg" />
        <CardImg className="w-60 h-60 mt-10  object-fill text-xl text-left" text="Our bathroom upgrade" link="https://i.pinimg.com/736x/3e/75/eb/3e75eb95dc4642761bf05603828e3caf.jpg" />
      </div>
    </div> 
    ...
    <div className='bg-bg-mint flex justify-center items-center h-screen'>
      <div className="w-1/2 h-full object-fill relative">
        <img 
          ...
          src="https://images.unsplash.com/photo-1521038199265-bc482db0f923?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        <div className='absolute bottom-24 left-24'>
          ...
          <img
            ...
            src="https://i.pinimg.com/736x/95/2a/b6/952ab62ca02aecde9d4a0ba58c2d0fea.jpg" alt="" />
      ...
      <div className='flex-1 items-center text-center'>
        <h1 className='text-5xl text-t2-pink font-bold my-4'>See it, Make it, <br/> Try it, do it</h1>
          <p  className='text-center text-2xl w-1/2 text-t2-pink mx-auto my-4'>
...
const Sec5 = () =>{
  return (
    <div className='relative backImg flex justify-around items-center h-screen bg-blend-darken'>
      ...
      <div className="bg-white rounded-3xl w-1/4 h-3/4 z-10 flex-2">
      </div>
